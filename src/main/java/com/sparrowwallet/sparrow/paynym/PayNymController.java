...
public class PayNymController {
    ...
    public void linkPayNym(PayNym payNym) {
        ...
        Optional<ButtonType> optButtonType = AppServices.showAlertDialog("Link PayNym?",
                ...
                "It will cost " + MINIMUM_P2PKH_OUTPUT_SATS + " tokens to create the link through a notification transaction, plus the mining fee. Send transaction?", Alert.AlertType.CONFIRMATION, previewType, ButtonType.CANCEL, sendType);
